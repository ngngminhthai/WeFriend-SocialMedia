...
import com.example.socialapp.databinding.FragmentAddPostBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.postBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(binding.postDescription.getText()!=null&&!binding.postDescription.getText().toString().isEmpty()){
                    Post post = new Post();
